...
const UInt32 Sha256::Private::K[64] = {
...
void Sha256::update(const Byte *data, usize size)
{
  CSha256 *p = this;
  ...
  while (size > 0)
  {
    ...
    {
      curBufferPos = 0;
      Private::WriteByteBlock(p);
    }
  }
}

void Sha256::finalize(byte (&digestBuf)[digestSize])
{
  CSha256 *p = this;
